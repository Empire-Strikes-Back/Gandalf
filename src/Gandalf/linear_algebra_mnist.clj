(ns Gandalf.linear-algebra-mnist
  (:require [Gandalf.linear-algebra-math :refer :all]
            [clojure.repl :refer :all]
            [clojure.java.io :refer [file output-stream input-stream]]
            [clojure.pprint  :as pp]
            [clojure.java.io :as io]
            [Gandalf.linear-algebra-kmeans :refer [k-means-rand-x->z k-means-rand-z k-means-rand-gs]]))
