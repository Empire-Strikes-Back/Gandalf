...
(ns csbooks.mxnet-rnn-train-char
  (:require  [clojure.string :as string]
             [clojure.java.shell :refer [sh]]
             [csbooks.mxnet-rnn-impl :as util]
             [csbooks.mxnet-rnn-lstm :as lstm]
             [csbooks.mxnet-rnn-test-char :as test-rnn]
...
;;https://github.com/apache/incubator-mxnet/blob/master/example/rnn/old/char-mxnet.rnn.ipynb
