...
(ns csbooks.mxnet-cnn-text-classifier
  (:require [clojure.java.io :as io]
            [clojure.java.shell :refer [sh]]
            [csbooks.mxnet-cnn-text-data]
...
(defn train-convnet [{:keys [devs embedding-size batch-size test-size
  ...
  (let [ms-dataset    (csbooks.mxnet-cnn-text-data/load-ms-with-embeddings mr-dataset-path max-examples embedding-size {:pretrained-embedding pretrained-embedding})
